...
class DataViewer:
    def __init__(self, app,  dt = 0.01,
        ...
        self._plotter.create_data_set(plot_id="alpha", data_label="alphac", data_color=estimate_color)
        ...
        self._plotter.create_plot_widget(plot_id='w', xlabel='Time (s)', ylabel='w (m/s)',
                                       window_length=self._data_window_length)
        self._plotter.create_plot_widget(plot_id='blank', xlabel='Time (s)', ylabel='delta_t (deg)',
                                       window_length=self._data_window_length)
        self._plotter.create_data_set(plot_id="gamma", data_label="gamma", data_color=control_color)
        self._plotter.create_data_set(plot_id="gamma", data_label="gammac", data_color=estimate_color)
    ...
    def __update_data(self, true_state, estimated_state, commanded_state, delta, t):
        ...
        if true_state != None:
            ...
            if commanded_state != None:
                ...
                self._plotter.add_data_point(plot_id='gamma', data_label='gamma', xvalue=t, yvalue=-true_state.gamma)
                self._plotter.add_data_point(plot_id='gamma', data_label='gammac', xvalue=t, yvalue=0)
                self._plotter.add_data_point(plot_id='alpha', data_label="alphac", xvalue=t, yvalue= self.__rad_to_deg(0))
